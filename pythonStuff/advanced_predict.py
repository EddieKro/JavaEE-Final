...
arguments = [[0 for x in range(22)],[]]
for i in sys.argv[1:22]:
	arguments[1].append(float(i))
month = datetime.date.today().month
arguments[1].append(datetime.date.today().month)
city_index = get_city_index(month,sys.argv[-1])
model = lgb.Booster(model_file='/Users/craq/Documents/GitHub/JavaEE-Final/pythonStuff/advanced_model.txt')
